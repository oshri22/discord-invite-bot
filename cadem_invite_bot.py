...
async def help(ctx):
    ...
    embed.add_field(name = "+invited_by" , value = "give one point to the user who invited you",inline=False)      #give it some content
...
@client.command(pass_context=True)
@commands.has_role("new role") # This must be exactly the name of the appropriate role
